					                         ...
					                         const GLdouble &xTimes, const GLdouble &zTimes)
{
	...
	glVertex3d(xStart + (xImgSize * xTimes), yStart,zStart + (zImgSize * zTimes));
							                 ...
							                 const GLdouble &xTimes, const GLdouble &yTimes, const bool &flip)
{
	...
	glVertex3d(xStart + (xImgSize * xTimes), yStart + (yImgSize * yTimes), zStart);
							                 ...
							                 const GLdouble &yTimes, const GLdouble &zTimes, const bool &flip)
{
	...
	glVertex3d(xStart,yStart + (yImgSize * yTimes), zStart + (zImgSize * zTimes));
