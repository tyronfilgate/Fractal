...
int main(int argc, char **argv)
{
	...
	glutDisplayFunc(&frac.GameState);

	glutIdleFunc(&frac.GameState);
...
void myinit()
{
	...
	peb.SetContents(&tp, &cam);
	frac.SetContents(&tp, &cam, &Display, &frac, &IncrementFrameCount, &stepIncrement, &angleIncrement, &width, &height);
	...
	cam.SetNoBoundingBoxes((40 + frac.getNumBoundingBoxes()*2));
	// set starting position of user
	//ORIGINAL START POSITION - cam.Position(32720.0, 9536.0,4800.0, 180.0);
	cam.Position(4400.0, 10450.0, 27000.0, 270.0);
...
void Display()
{
	...
	glPushMatrix();	
		...
		if (peb.CanEnterFractal()){
			peb.DisplayEnterPrompt(width, height);
		}
...
void keys(unsigned char key, int x, int y)
{
	...
	switch (key)
	{
		...
		case 'E':
			...
			break;
		case 13:
			if (frac.getState() == 2 || frac.getState() == 3){
				if (frac.getState() == 2) frac.setState(3);
				else{
					frac.setState(4);
				}
			}
...
void CreateBoundingBoxes()
{
	...
	cam.SetAABBMinY(0, 5000.0);
	cam.SetAABBMaxY(0, 30000.0);
	...
	cam.SetAABBMinY(1, 5000.0);
	cam.SetAABBMaxY(1, 30000.0);
	...
	cam.SetAABBMinY(2, 5000.0);
	cam.SetAABBMaxY(2, 30000.0);
	...
	cam.SetAABBMinY(3, 5000.0);
	cam.SetAABBMaxY(3, 30000.0);
	...
	cam.SetAABBMinY(4, 5000.0);
	cam.SetAABBMaxY(4, 30000.0);
	...
	cam.SetAABBMinY(5, 5000.0);
	cam.SetAABBMaxY(5, 30000.0);
	...
	cam.SetAABBMinY(6, 5000.0);
	cam.SetAABBMaxY(6, 30000.0);
	...
	cam.SetAABBMinY(7, 5000.0);
	cam.SetAABBMaxY(7, 30000.0);
	...
	cam.SetAABBMinY(8, 5000.0);
	cam.SetAABBMaxY(8, 30000.0);
	...
	cam.SetAABBMinY(9, 5000.0);
	cam.SetAABBMaxY(9, 30000.0);
	...
	cam.SetAABBMinY(10, 5000.0);
	cam.SetAABBMaxY(10, 30000.0);
	...
	cam.SetAABBMinY(11, 5000.0);
	cam.SetAABBMaxY(11, 30000.0);
	...
	cam.SetAABBMinY(13, 5000.0);
	cam.SetAABBMaxY(13, 30000.0);
	...
	cam.SetAABBMinY(14, 5000.0);
	cam.SetAABBMaxY(14, 30000.0);
	...
	cam.SetAABBMinY(15, 5000.0);
	cam.SetAABBMaxY(15, 30000.0);
	...
	cam.SetAABBMinY(16, 5000.0);
	cam.SetAABBMaxY(16, 30000.0);
...
{	
	...
	cam.SetPlains (FLAT_PLAIN, 2108.0, 6500.0 , 10450.0, 10450.0, 17000.0, 40000.0);
...
void CreateTextures()
{
	...
	image = tp.LoadTexture("data/exit.raw", 2048, 2048);
	tp.CreateTexture(FRACTAL_EXIT, image, 2048, 2048);

	image = tp.LoadTexture("data/entryprompt.raw", 512, 128);
	tp.CreateTexture(ENTRY_PROMPT, image, 512, 128);

	image = tp.LoadTexture("data/splashscreen.raw", 2048, 2048);
	tp.CreateTexture(FRACTAL_WELCOME, image, 2048, 2048);

	image = tp.LoadTexture("data/instructions.raw", 2048, 2048);
	tp.CreateTexture(FRACTAL_INSTRUCTIONs, image, 2048, 2048);

	image = tp.LoadTexture("data/carpet3.raw", 128, 128);
	tp.CreateTexture(CARPET3, image, 128, 128);
	
	image = tp.LoadTexture("data/Psy0Door.raw", 512, 1024);
	tp.CreateTexture(PSY_0_DOOR, image, 512, 1024);
	
	image = tp.LoadTexture("data/Psy1Door.raw", 512, 1024);
	tp.CreateTexture(PSY_1_DOOR, image, 512, 1024);
	
	image = tp.LoadTexture("data/Psy15Door.raw", 512, 1024);
	tp.CreateTexture(PSY_15_DOOR, image, 512, 1024);
	
	image = tp.LoadTexture("data/Psy15Window.raw", 512, 512);
	tp.CreateTexture(PSY_15_WINDOW, image, 512, 512);
...
void DisplayChancPosts ()
{
	...
	glCallList(235);
	glPushMatrix();
		glTranslated(0.0, 320.0, 7447.0);
		glCallList(235);
	glPopMatrix();
	glPushMatrix();
		glTranslated(0.0, 1024.0, 0.0);
		glCallList(235);
	glPopMatrix();
	glPushMatrix();
		glTranslated(0.0, 320.0, 5527);
		glCallList(235);
	glPopMatrix();
	glPushMatrix();
		glTranslated(0.0, 320.0, 6551);
		glCallList(235);
	glPopMatrix();
	glPushMatrix();
		glTranslated(0.0, 320.0, 8471);
		glCallList(235);
	glPopMatrix();
	glPushMatrix();
		glTranslated(0.0, 1152.0, 19031.0);
		glCallList(235);
	glPopMatrix();
	...
	glCallList(237);
	glPushMatrix();
		glTranslated(0.0, 0.0, -960.0);
		glCallList(237);
	glPopMatrix();
	glPushMatrix();
		glTranslated(0.0, 0.0, -8640.0);
		glCallList(237);
	glPopMatrix();
	glPushMatrix();
		glTranslated(0.0, 0.0, -9600.0);
		glCallList(237);
	glPopMatrix();

	//glPushMatrix();
		//glTranslated(0.0, 320.0, -9600.0);
		//glCallList(237);
//	glPopMatrix();
	...
	glPopMatrix();
	glPushMatrix();
		glTranslated(0.0, 320.0, 7383.0);
		glCallList(236);
	glPopMatrix();
	glPushMatrix();
		glTranslated(0.0, 320.0, 5463);
		glCallList(236);
	glPopMatrix();
	glPushMatrix();
		glTranslated(0.0, 320.0, 6551);
...
void DrawChancPosts ()
{
	...
	glNewList(15, GL_COMPILE); 
		glBegin(GL_QUADS);
			...
			glVertex3d(33808.0, 10224.0, 9552.0);
			glTexCoord2d(0.0, 0.9375);
			glVertex3d(33808.0, 10224.0, 9552.0 + (1024.0 * 0.9375));
			glTexCoord2d(1.0, 0.9375);
			glVertex3d(33928.0, 10268.0, 9552.0 + (1024.0 * 0.9375));
			glTexCoord2d(1.0, 0.0);
			glVertex3d(33928.0, 10268.0, 9552.0);
		glEnd();
	glEndList();
	...
	glNewList(237, GL_COMPILE); 
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(33808.0, 10225.0, 20112.0);
			glTexCoord2d(0.0, 0.5);
			glVertex3d(33808.0, 10192.0, 20112.0);
			glTexCoord2d(0.5, 0.5);
			glVertex3d(33872.0, 10192.0, 20112.0);
			glTexCoord2d(0.5, 0.0);
			glVertex3d(33872.0, 10247.0, 20112.0);
		glEnd();
	glEndList();
...
void DisplayAboveWindowBlock ()
{
	...
	glPopMatrix();
	glPushMatrix();	
		glTranslated(0.0, 1024.0, 15783.0);
		glCallList(49);
	glPopMatrix();
	glPushMatrix();	
		glTranslated(-2068.0, 310.0, -17244.0);
		glCallList(49);
	glPopMatrix();
	glCallList(425);
	...
	glBindTexture(GL_TEXTURE_2D, tp.GetTexture(ABOVE_WINDOW_BLOCK_XY_3));
		glCallList(50);
	glPushMatrix();	
		glTranslated(0.0, 0.0, 807.0);
		glCallList(50);
	glPopMatrix();
	glPushMatrix();	
		glTranslated(0.0, 0.0, 9567.0);
		glCallList(50);
	glPopMatrix();
	glPushMatrix();	
		glTranslated(0.0, 0.0, 11103.0);
		glCallList(50);
	glPopMatrix();
...
void DrawAboveWindowBlock ()
{
	...
	glNewList(232, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(31768.0 + 45, 11162, 41011.2 - 45);
			glTexCoord2d(10.54, 0.0);
			glVertex3d(33848+ 45, 11920, 43095.2 -45 );
			glTexCoord2d(10.54, 1.0);
			glVertex3d(33848.0- 45, 11920, 43095.2 +45);
	...
	glNewList(233, GL_COMPILE);
		glBegin(GL_QUADS);
			...
			glTexCoord2d(10.54, 0.0);
			glVertex3d(33848- 45, 11920, 43095.2 +45 );
			glTexCoord2d(10.54, 0.75);
			glVertex3d(33848.0- 45, 11920 +192, 43095.2 +45);
			glTexCoord2d(0.0, 0.75);
			glVertex3d(31768.0- 45, 11162 +192, 41011.2 + 45);
		glEnd();
	glEndList();
...
void DisplayPurplePosts ()
{
	...
	for (int i = 0; i < 3; i++)
	{
		...
		glPopMatrix();
		glPushMatrix();
			glTranslated(0.0, 0.0, step + 78.0);
			glCallList(31);
		glPopMatrix();
		step += 960.0;
		if (i == 1) step += 960.0;
...
void DisplayRedPosts ()
{
	...
	glPushMatrix();
		glTranslated(0.0, 0.0, 240.0);
		glCallList(35);
	glPopMatrix();
	glPushMatrix();
		glTranslated(0.0, 0.0, 256.0);
		glCallList(35);
	glPopMatrix();
	glPushMatrix();
		glTranslated(0.0, 0.0, 1639.0);
		glCallList(35);
	glPopMatrix();
	glPushMatrix();
		glTranslated(0.0, 0.0, 1095.0);
		glCallList(35);
	glPopMatrix();
	glPushMatrix();
		glTranslated(0.0, 0.0, 1191.0);
		glCallList(35);
	glPopMatrix();
	glPushMatrix();
		glTranslated(0.0, 0.0, 1655.0);
		glCallList(35);
	glPopMatrix();
}
...
void DisplayMainPosts ()
{
	...
	{
		glPushMatrix();	
			glTranslated(stepLength, 0.0, step2);
			for (int i = 0; i < 17; i++)
			{		
				...
				glPopMatrix();
				glPushMatrix();
					glTranslated(0.0, 0.0, step + 128.0);
					glCallList(18);
				glPopMatrix();
				if ((i == 7) && (j ==0))	// between chanc and phys sci
				{
					glPushMatrix();	
						glTranslated(4008.0, 0.0, step);
						glCallList(18);
					glPopMatrix();
					glPushMatrix();
						glTranslated(4008.0, 0.0, step + 128.0);
						glCallList(18);
					glPopMatrix();
				}
	...
	{		
		glBindTexture(GL_TEXTURE_2D, tp.GetTexture(MAIN_POST));
		glPushMatrix();	
			glTranslated(step, 0.0, 30880.0);
			glCallList(18);
		glPopMatrix();
		glPushMatrix();
			glTranslated(step, 0.0, 31008.0);
			glCallList(18);
		glPopMatrix();
		...
		glPopMatrix();
		glPushMatrix();
			glTranslated(step + 128.0, 0.0, 30880.0);
			glCallList(19);
		glPopMatrix();
		step -= 1940.0;
	}
...
void DisplayPhysSciPosts ()
{
	...
	for (int i = 0; i < 4; i++)
	{
		...
		glPushMatrix();
			glBindTexture(GL_TEXTURE_2D, tp.GetTexture(WINDOWPOST_PHYSSCI_LEFT));
			glTranslated(0.0, -1024.0, step + 77);
			glCallList(38);
		glPopMatrix();
		step += 960.0;
	}
		glPushMatrix();	
			glBindTexture(GL_TEXTURE_2D, tp.GetTexture(WINDOWPOST_PHYSSCI_FRONT));
			glTranslated(0.0, -1024.0, 7718.0);
			glCallList(36);
			glBindTexture(GL_TEXTURE_2D, tp.GetTexture(WINDOWPOST_PHYSSCI_RIGHT));
			glCallList(37);
		glPopMatrix();
		glPushMatrix();
			glBindTexture(GL_TEXTURE_2D, tp.GetTexture(WINDOWPOST_PHYSSCI_LEFT));
			glTranslated(0.0, -1024.0, 7718.0 + 77);
			glCallList(38);
		glPopMatrix();
	...
	{
		glPushMatrix();
			glTranslated(0.0, stepLength, step);
			glBindTexture(GL_TEXTURE_2D, tp.GetTexture(WINDOWLEDGE_PS_FRONT));
			glCallList(16);
			glBindTexture(GL_TEXTURE_2D, tp.GetTexture(WINDOWLEDGE_PS_TOP));
...
void DrawPhysSciPosts ()
{
	...
	glNewList(40, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(33808.0, 10544.0, 33421.0);
			glTexCoord2d(0.0, 0.9375);
			glVertex3d(33808.0, 10544.0, 33421.0 + (1024.0 * 0.9375));
			glTexCoord2d(1.0, 0.9375);
			glVertex3d(33928.0, 10588.0, 33421.0 + (1024.0 * 0.9375));
			glTexCoord2d(1.0, 0.0);
			glVertex3d(33928.0, 10588.0, 33421.0);
		glEnd();
	glEndList();
	...
	glNewList(41, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(33808.0, 10288.0, 38239.0);
			glTexCoord2d(0.0, 0.315);
			glVertex3d(33808.0, 10288.0, 38239.0 + (1024.0 * 0.315));
			glTexCoord2d(1.0, 0.315);
			glVertex3d(33928.0, 10332.0, 38239.0 + (1024.0 * 0.315));
			glTexCoord2d(1.0, 0.0);
			glVertex3d(33928.0, 10332.0, 38239.0);
		glEnd();
	glEndList();
	...
	glNewList(17, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(33808.0, 11376.0, 26663.0);
			glTexCoord2d(0.0, 0.9375);
			glVertex3d(33808.0, 11376.0, 26663.0 + (1024.0 * 0.9375));
			glTexCoord2d(1.0, 0.9375);
			glVertex3d(33928.0, 11420.0, 26663.0 + (1024.0 * 0.9375));
			glTexCoord2d(1.0, 0.0);
			glVertex3d(33928.0, 11420.0, 26663.0);
		glEnd();
	glEndList();
}
...
void DisplayLibraryPosts ()
{
	...
	{
		glPushMatrix();
			glTranslated(0.0, stepLength, 0.0);
			step = 0.0;
			for (int i = 0; i < 15; i++)
			{
				if (!(i > 12 && j == 0))
	...
	glPushMatrix();
		glTranslated(1088.0, 1024.0, 0.0);
		glBindTexture(GL_TEXTURE_2D, tp.GetTexture(WINDOWLEDGE_LIB_A));
		glCallList(60);
		glBindTexture(GL_TEXTURE_2D, tp.GetTexture(WINDOWLEDGE_LIB_B));
		glCallList(61);
...
void DrawLibraryPosts ()
{
	...
	glNewList(62, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(21896.0, 10352.0, 43056.0);
			glTexCoord2d(0.5313, 0.0);
			glVertex3d(21896.0 + (1024.0 * 0.5313), 10352.0, 43056.0);
			glTexCoord2d(0.5313, 1.0);
			glVertex3d(21896.0 + (1024.0 * 0.5313), 10396.0, 43176.0);
			glTexCoord2d(0.0, 1.0);
			glVertex3d(21896.0 , 10396.0, 43176.0);
		glEnd();
	glEndList();
	glNewList(63, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(22440.0, 10352.0, 43056.0);
			glTexCoord2d(0.5313, 0.0);
			glVertex3d(22440.0 + (1024.0 * 0.5313), 10352.0, 43056.0);
			glTexCoord2d(0.5313, 1.0);
			glVertex3d(22440.0 + (1024.0 * 0.5313), 10396.0, 43176.0);
			glTexCoord2d(0.0, 1.0);
			glVertex3d(22440.0 , 10396.0, 43176.0);
		glEnd();
	glEndList();
...
{
	// PAVEMENT
	tp.CreateDisplayList (XZ, 87, 128.0, 64.0,  2108.0, 10000.0, 10000.0, 20.9, 482.5);
	...
	glNewList(89, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(31568.0, 10000.0, 40816.0);
			glTexCoord2d(17.5, 0.0);
			glVertex3d(33808.0, 10000.0, 40816.0);
			glTexCoord2d(17.5, 35.0);
			glVertex3d(33808.0, 10000.0, 43056.0);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(31568.0, 10000.0, 40816.0);
		glEnd();
	glEndList();
	glNewList(91, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(31504.0, 10000.0, 40880.0);
			glTexCoord2d(34.0, 17.0);
			glVertex3d(33680.0, 10000.0, 43056.0);
			glTexCoord2d(34.0, 17.0);
			glVertex3d(33680.0, 10000.0, 43056.0);
			glTexCoord2d(0.0, 17.0);
			glVertex3d(31504.0, 10000.0, 43056.0);
		glEnd();
	glEndList();
	glNewList(93, GL_COMPILE);
		glBegin(GL_QUADS);
			...
			glVertex3d(31504.0, 10000.0, 40880.0);
			glTexCoord2d(1.0, 0.0);
			glVertex3d(31632.0, 10000.0, 40880.0);
			glTexCoord2d(18.0, 17.0);
			glVertex3d(33808.0, 10000.0, 43056.0);
			glTexCoord2d(17.0, 17.0);
			glVertex3d(33680.0, 10000.0, 43056.0);
		glEnd();
	glEndList();
	...
	glNewList(90, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(2608.0, 10000.0, 40816.0);
			glTexCoord2d(17.5, 0.0);
			glVertex3d(4848.0, 10000.0, 40816.0);
			glTexCoord2d(17.5, 0.0);
			glVertex3d(4848.0, 10000.0, 40816.0);
			glTexCoord2d(0.0, 35.0);
			glVertex3d(2608.0, 10000.0, 43056.0);
		glEnd();
	glEndList();
	...
	glNewList(92, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(4912.0, 10000.0, 40880.0);
			glTexCoord2d(34.0, 17.0);
			glVertex3d(2736.0, 10000.0, 43056.0);
			glTexCoord2d(34.0, 17.0);
			glVertex3d(2736.0, 10000.0, 43056.0);
			glTexCoord2d(0.0, 17.0);
			glVertex3d(4912.0, 10000.0, 43056.0);
		glEnd();
	glEndList();

	glNewList(94, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(17.0, 0.0);
			glVertex3d(4784.0, 10000.0, 40880.0);
			glTexCoord2d(18.0, 0.0);
			glVertex3d(4912.0, 10000.0, 40880.0);
			glTexCoord2d(1.0, 17.0);
			glVertex3d(2736.0, 10000.0, 43056.0);
			glTexCoord2d(0.0, 17.0);
			glVertex3d(2608.0, 10000.0, 43056.0);
		glEnd();
...
void DisplayBricks ()
{
	...
	glCallList(999);	//TF - split the wall for PsyEx Doorway
	...
	for (int i = 126; i < 130; i ++) glCallList(i);
		glPushMatrix();
		glTranslated(-896.0, 0.0, 0.0);
		glCallList(128);
	glPopMatrix();
	glPushMatrix();
		glTranslated(0.0, 1088.0, 0.0);
		glCallList(129);
		glCallList(168);
	glPopMatrix();
...
void DrawBricks ()
{
	...
	tp.CreateDisplayList(YZ, 122, 128.0, 128.0, 2608.0, 10000.0, 10000.0, 7.0, 130.0);		// long downstairs panel
	tp.CreateDisplayList(YZ, 999, 128.0, 128.0, 2608.0, 10000.0, 28000.0, 7.0, 102.9);		//TF - split the wall for PsyEx Doorway
...
void DisplayRoof()
{
	...
	glPushMatrix();
		glTranslated(0.0, 0.0, -99.0);
		glCallList(298);
	glPopMatrix();
	glPushMatrix();
		glTranslated(0.0, 0.0, 1798.0);
		glCallList(298);
	glPopMatrix();
	...
	for (int i = 0; i < 85; i++)
	{
		...
		glPopMatrix();
		glPushMatrix();
			glTranslated(0.0, 0.0, step + 32.0);
			glCallList(255);
		glPopMatrix();
		step += 386.0;
	}
	...
	for (int i = 0; i < 70; i++)
	{
		...
		glPopMatrix();
		glPushMatrix();
			glTranslated(step + 32.0, 0.0, 0.0);
			glCallList(297);
		glPopMatrix();
	...
	glCallList(427);
	glPushMatrix();
		glTranslated(0.0, 49.0, 3248.0);
		glCallList(427);
	glPopMatrix();
	glPushMatrix();
		glTranslated(0.0, 49.0, 19031.0);
		glCallList(427);
	glPopMatrix();
...
void DrawRoof()
{
	...
	glNewList(214, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(31740.0, 11364.0, 8100.0);
			glTexCoord2d(0.0, 257.9);
			glVertex3d(31740.0, 11364.0, 8100.0 + (128.0 * 257.9));
			glTexCoord2d(2.0, 273.4);
			glVertex3d(33848.0, 12140.72, 8100.0 + (128.0 * 273.4));
			glTexCoord2d(2.0, 0.0);
			glVertex3d(33848.0, 12140.72, 8100.0);
		glEnd();
		glEndList();
	// Canteen Top of Roof
	glNewList(215, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(2608.0, 12140.72, 8100.0);
			glTexCoord2d(0.0, 273.4);
			glVertex3d(2608.0, 12140.72, 8100.0 + (128.0 * 273.4));
			glTexCoord2d(2.0, 257.9);
			glVertex3d(4716.0, 11364.0, 8100.0 + (128.0 * 257.9));
			glTexCoord2d(2.0, 0.0);
			glVertex3d(4716.0, 11364.0, 8100.0);
		glEnd();
	glEndList();
	// Library Top of Roof
	glNewList(216, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(4716.0, 11364.0, 40983.2);
			glTexCoord2d(211.125, 0.0);
			glVertex3d(4716.0 + (128.0 * 211.125), 11364.0, 40983.2);
			glTexCoord2d(227.59, 16.15);
			glVertex3d(4716.0 + (128.0 * 227.59), 12140.72, 43095.2);
			glTexCoord2d(-16.47, 16.15);
			glVertex3d(2608.0, 12140.72, 43095.2);
		glEnd();
	glEndList();
	// Chanc Side Planks
	glNewList(250, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(31868.0, 11366.0, 8100.0);
			glTexCoord2d(0.0, 257.9);
			glVertex3d(31868.0, 11366.0, 8100.0 + (128.0 * 257.9));
			glTexCoord2d(16.48, 273.4);
			glVertex3d(33848.0, 12094.72, 8100.0 + (128.0 * 273.4));
			glTexCoord2d(16.48, 0.0);
			glVertex3d(33848.0, 12094.72, 8100.0);
		glEnd();
	glEndList();
	...
	glNewList(253, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(31868.0, 11284.0, 10105.0);
			glTexCoord2d(0.0, 1.0);
			glVertex3d(31868.0, 11284.0, 10137.0);
			glTexCoord2d(16.48, 1.0);
			glVertex3d(33848.0, 12012.72, 10137.0);
			glTexCoord2d(16.48, 0.0);
			glVertex3d(33848.0, 12012.72, 10105.0);
		glEnd();
	glEndList();
	...
	glNewList(255, GL_COMPILE);
		glBegin(GL_QUADS);
			...
			glVertex3d(31868.0, 11284.0, 10105.0);
			glTexCoord2d(0.0, 1.0);
			glVertex3d(31868.0, 11284.0 + 82.0, 10105.0);
			glTexCoord2d(16.48, 1.0);
			glVertex3d(33848.0, 12012.72 + 82.0, 10105.0);
			glTexCoord2d(16.48, 0.0);
			glVertex3d(33848.0, 12012.72, 10105.0);
		glEnd();
	glEndList();
	...
	glNewList(251, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(35748.0, 11366.0, 22046.0);
			glTexCoord2d(0.0, 25.79);
			glVertex3d(35748.0, 11366.0, 22046.0 + (128.0 * 25.79));
			glTexCoord2d(15.82, 25.79);
			glVertex3d(33848.0, 12065.28, 22046.0 + (128.0 * 25.79));
			glTexCoord2d(15.82, 0.0);
			glVertex3d(33848.0, 12065.28, 22046.0);
		glEnd();
	glEndList();
	...
	glNewList(254, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(35748.0, 11284.0, 22096.0);
			glTexCoord2d(0.0, 1.0);
			glVertex3d(35748.0, 11284.0, 22096.0 + 32.0);
			glTexCoord2d(15.82, 1.0);
			glVertex3d(33848.0, 11983.28, 22096.0 + 32.0);
			glTexCoord2d(15.82, 0.0);
			glVertex3d(33848.0, 11983.28, 22096.0);
		glEnd();
	glEndList();
	...
	glNewList(256, GL_COMPILE);
		glBegin(GL_QUADS);
			...
			glVertex3d(35748.0, 11284.0, 22096.0);
			glTexCoord2d(0.0, 1.0);
			glVertex3d(35748.0, 11284.0 + 82.0, 22096.0);
			glTexCoord2d(15.82, 1.0);
			glVertex3d(33848.0, 11983.28 + 82.0, 22096.0);
			glTexCoord2d(15.82, 0.0);
			glVertex3d(33848.0, 11983.28, 22096.0);
		glEnd();
	glEndList();
	...
	glNewList(252, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(36108.0, 11019.68, 41127.0);
			glTexCoord2d(0.0, 15.1);
			glVertex3d(36108.0, 11019.68, 41127.0 + (128.0 * 15.1));
			glTexCoord2d(19.44, 15.1);
			glVertex3d(33848.0, 12061.55, 41127.0 + (128.0 * 15.1));
			glTexCoord2d(19.44, 0.0);
			glVertex3d(33848.0, 12061.55, 41127.0);
		glEnd();
	glEndList();
	...
	glNewList(298, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(36108.0, 10937.68, 41226.0);
			glTexCoord2d(0.0, 1.0);
			glVertex3d(36108.0, 10937.68, 41226.0 + 32.0);
			glTexCoord2d(19.44, 1.0);
			glVertex3d(33848.0, 11979.55, 41226.0 + 32.0);
			glTexCoord2d(19.44, 0.0);
			glVertex3d(33848.0, 11979.55, 41226.0);
		glEnd();
	glEndList();
	...
	glNewList(299, GL_COMPILE);
		glBegin(GL_QUADS);
			...
			glVertex3d(36108.0, 10937.68, 41226.0);
			glTexCoord2d(0.0, 1.0);
			glVertex3d(36108.0, 10937.68 + 82.0, 41226.0);
			glTexCoord2d(19.44, 1.0);
			glVertex3d(33848.0, 11979.55 + 82.0, 41226.0);
			glTexCoord2d(19.44, 0.0);
			glVertex3d(33848.0, 11979.55, 41226.0);
		glEnd();
	glEndList();
	...
	glNewList(257, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(4541.0, 11366.0, 43056.0 - 1942.0);
			glTexCoord2d(213.45, 0.0);
			glVertex3d(4541.0 + (128.0 * 213.45), 11366.0, 43056.0 - 1942.0);
			glTexCoord2d(228.6, 16.15);
			glVertex3d(4541.0 + (128.0 * 213.45) + 1940.0, 12080.0, 43056.0);
			glTexCoord2d(-15.1, 16.15);
			glVertex3d(2608.0, 12080.0, 43056.0);
		glEnd();
	glEndList();
	...
	glNewList(296, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(4541.0, 11283.0, 41114.0);
			glTexCoord2d(0.0, 1.0);
			glVertex3d(4573.0, 11283.0, 41114.0);
			glTexCoord2d(16.15, 1.0);
			glVertex3d(4573.0, 11997.0, 43056.0);
			glTexCoord2d(16.15, 0.0);
			glVertex3d(4541.0, 11997.0, 43056.0);
		glEnd();
	glEndList();
	// Library Side Beams
	glNewList(297, GL_COMPILE);
		glBegin(GL_QUADS);
			...
			glVertex3d(4541.0, 11283.0, 41114.0);
			glTexCoord2d(0.0, 1.0);
			glVertex3d(4541.0, 11365.0, 41114.0);
			glTexCoord2d(16.15, 1.0);
			glVertex3d(4541.0, 12079.0, 43056.0);
			glTexCoord2d(16.15, 0.0);
			glVertex3d(4541.0, 11997.0, 43056.0);
		glEnd();
	glEndList();
...
void DrawAngledRoofBeam (int listNo, GLdouble x, GLdouble y, GLdouble z, GLdouble beamSize)
{
	glNewList(listNo, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(x, y, z + 32.0);
			glTexCoord2d(0.0, 1.0);
			glVertex3d(x, y, z);
			glTexCoord2d(beamSize, 1.0);
			glVertex3d(33848.0, 12012.72, z);
			glTexCoord2d(beamSize, 0.0);
			glVertex3d(33848.0, 12012.72, z + 32.0);
		glEnd();
	glEndList();
	glNewList(listNo + 5, GL_COMPILE);
		glBegin(GL_QUADS);
			...
			glVertex3d(x, y, z);
			glTexCoord2d(0.0, 1.0);
			glVertex3d(x, y + 82.0, z);
			glTexCoord2d(beamSize, 1.0);
			glVertex3d(33848.0, 12012.72 + 82.0, z);
			glTexCoord2d(beamSize, 0.0);
			glVertex3d(33848.0, 12012.72, z);
		glEnd();
	glEndList();
...
void DrawAngledRoofBeam2 (int listNo, GLdouble x, GLdouble y, GLdouble z, GLdouble beamSize)
{
	glNewList(listNo, GL_COMPILE);
		glBegin(GL_QUADS);
			...
			glVertex3d(x, y, z);
			glTexCoord2d(1.0, 0.0);
			glVertex3d(x + 32.0, y, z);
			glTexCoord2d(1.0, beamSize);
			glVertex3d(x + 32.0, 11998.0, 43056);
			glTexCoord2d(0.0, beamSize);
			glVertex3d(x, 11998.0, 43056);
		glEnd();
	glEndList();
	glNewList(listNo + 5, GL_COMPILE);
		glBegin(GL_QUADS);
			...
			glVertex3d(x, y + 82.0, z);
			glTexCoord2d(1.0, beamSize);
			glVertex3d(x, 11998.0 + 82.0, 43056);
			glTexCoord2d(0.0, beamSize);
			glVertex3d(x, 11998.0, 43056);
		glEnd();
	glEndList();
...
void DisplayEntranceSteps ()
{
	...
	{
		glPushMatrix();
			glTranslated(step, step2, 0.0);
			glCallList(206);
		glPopMatrix();
		glPushMatrix();
			glTranslated(step, step2, 965.0);
			glCallList(206);
		glPopMatrix();
		step += 128.0;
		step2 += -51.0;
...
void DisplayBench ()
{
	...
	{	
		glPushMatrix();
			glTranslated(step2, 0.0, vertStep);
...
void DisplayExtras ()
{
	...
	glPopMatrix();
	glPushMatrix();
		glTranslated(3904.0, 0.0, 0.0);
		glCallList(311);
	glPopMatrix();
	glPushMatrix();
		glTranslated(4800.0, 0.0, 0.0);
		glCallList(311);
	glPopMatrix();
	glCallList(435);
	glPushMatrix();
		glTranslated(768.0, 0.0, 0.0);
		glCallList(435);
	glPopMatrix();
	...
	glCallList(320);
	glPushMatrix();
		glTranslated(317.12, 0.0, 0.0);
		glCallList(321);
	glPopMatrix();
	glCallList(320);
	glPushMatrix();
		glTranslated(255.0, 0.0, 0.0);
		glCallList(322);
	glPopMatrix();
	...
	for (int i= 0; i < 2; i++)
	{
		glPushMatrix();
			...
			glCallList(349);
			glPushMatrix();
				glTranslated(0.0, 0.0, 168.2);
				glCallList(349);
			glPopMatrix();
			glCallList(388);
			glPushMatrix();
				glTranslated(275.2, 0.0, 0.0);
				glCallList(388);
			glPopMatrix();
	...
	glBindTexture(GL_TEXTURE_2D, tp.GetTexture(KBLT_SIDE_1));
	glPushMatrix();
		glTranslated(-2496.0, 0.0, 0.0);
		glCallList(345);
	glPopMatrix();	

	glBindTexture(GL_TEXTURE_2D, tp.GetTexture(KBLT_SIDE_2));
	glPushMatrix();
		glTranslated(-2316.0, 0.0, 0.0);			
		glCallList(346);
	glPopMatrix();
...
void DrawExtras ()
{
	...
	glNewList(338, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(33890.0, 10633.0, 25178.0);
			glTexCoord2d(0.527, 0.0);
			glVertex3d(34160.0, 10633.0, 25178.0);
			glTexCoord2d(0.473, 0.54);
			glVertex3d(34132.0, 10697.84, 25201.6);
			glTexCoord2d(0.055, 0.54);
			glVertex3d(33918.0, 10697.84, 25201.6);
		glEnd();
	glEndList();
	glNewList(341, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(33891.0, 10633.0, 25178.0);
			glTexCoord2d(0.0, 0.637);
			glVertex3d(33891.0, 10633.0, 25341.0);
			glTexCoord2d(0.54, 0.538);
			glVertex3d(33918.5, 10697.84, 25315.6);
			glTexCoord2d(0.54, 0.1);
			glVertex3d(33918.5, 10697.84, 25201.6);
		glEnd();
	glEndList();
	glNewList(342, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(34159.5, 10633.0, 25178.0);
			glTexCoord2d(0.0, 0.637);
			glVertex3d(34159.5, 10633.0, 25341.0);
			glTexCoord2d(0.54, 0.538);
			glVertex3d(34132.0, 10697.84, 25315.6);
			glTexCoord2d(0.54, 0.1);
			glVertex3d(34132.0, 10697.84, 25201.6);
		glEnd();
	glEndList();
	glNewList(340, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(33890.0, 10631.0, 25341.0);
			glTexCoord2d(0.527, 0.0);
			glVertex3d(34160.0, 10631.0, 25341.0);
			glTexCoord2d(0.473, 0.535);
			glVertex3d(34132.0, 10697.84, 25315.4);
			glTexCoord2d(0.055, 0.535);
			glVertex3d(33918.0, 10697.84, 25315.4);
		glEnd();
	glEndList();
	glNewList(395, GL_COMPILE);
		glBegin(GL_QUADS);
			glTexCoord2d(0.0, 0.0);
			glVertex3d(33882.0, 10268.0, 25250.0);
			glTexCoord2d(1.0, 0.0);
			glVertex3d(33898.0, 10268.0, 25250.0);
			glTexCoord2d(1.0, 0.729);
			glVertex3d(33898.0, 10598.24, 25173.0);
			glTexCoord2d(0.0, 0.729);
			glVertex3d(33882.0, 10598.24, 25173.0);
		glEnd();
	glEndList();
...
void DisplayLargerTextures ()
{
	...
	glPushMatrix();
		glTranslated(0.0, 0.0, 3840.0);
		glCallList(352);
	glPopMatrix();
	glPushMatrix();
		glTranslated(0.0, 0.0, 10560.0);
		glCallList(352);
	glPopMatrix();
...
void DisplayLights ()
{
	...
	{
		glPushMatrix();
			glTranslated(32905.0, 11200.0, 11134.0 + beamstep);
		...
		glPushMatrix();
			glTranslated(32905.0, 11265.0, 11134.0 + beamstep);
			glRotated( 90.0, 1.0f, 0.0f, 0.0f );
			glRotated( -90.0, 0.0f, 0.0f, 1.0f );
			glCallList(376);
		glPopMatrix();
		...
		glPushMatrix();
			glTranslated(32905.0, 11330.0, 11134.0 + beamstep);
			 glRotated( 90.0, 1.0f, 0.0f, 0.0f );
			 glRotated( -90.0, 0.0f, 0.0f, 1.0f );
			glCallList(376);
		glPopMatrix();
	...
	for (int i = 0; i < 4; i++)
	{
		...
		for (int k = 0; k < 2; k++)
		{
			...
			{
				glPushMatrix();
					glTranslated(step, 0.0, 0.0 + beamstep);
					glCallList(377);
				glPopMatrix();
				glPushMatrix();
					glTranslated(step, 0.0, -40.0 + beamstep);
					glCallList(377);
				glPopMatrix();
				step += 8.0;
			}
		...
		for (int k = 0; k < 2; k++)
		{
			...
			{
				glPushMatrix();
					glTranslated(step, 0.0, 0.0 + step2 + beamstep);
					glCallList(378);
				glPopMatrix();
				glPushMatrix();
					glTranslated(step, 0.0, -40.0 + step2 + beamstep);
					glCallList(378);
				glPopMatrix();
				step2 += 8.0;
			}
...
void DisplayCylinders ()
{
	...
	glPushMatrix();
		glTranslated(24200.0, 9850.0, 43090.0);
		glRotated( 90.0, 1.0f, 0.0f, 0.0f );
		glRotated( -90.0, 0.0f, 0.0f, 1.0f );
		glRotated( -180.0, 0.0f, 1.0f, 0.0f );
	...
	glCallList(439);
	glPushMatrix();
		glTranslated(33800.0, 10340.0, 34848.0);
		glRotated( 90.0, 1.0f, 0.0f, 0.0f );
		glRotated( -90.0, 0.0f, 0.0f, 1.0f );
		glCallList(441);
...
void DisplayStepBricks ()
{
	...
	for (int j = 0; j < 2; j++)
	{
		glPushMatrix();
			...
			glPushMatrix();
				glTranslated(31572.0, 9222.0, 6126.0);
				glRotated( -18.69, 1.0f, 0.0f, 0.0f );
				glTranslated(-31572.0, -9222.0, -6126.0);
				glCallList(493);
			glPopMatrix();

			glPushMatrix();
				glTranslated(31572.0, 9461.0, 7213.0);
				glRotated( -20.31, 1.0f, 0.0f, 0.0f );
				glTranslated(-31572.0, -9462.0, -7213.0);
				glCallList(494);
			glPopMatrix();

			glPushMatrix();
				glTranslated(31572.0, 9722.0, 8302.0);
				glRotated( -17.35, 1.0f, 0.0f, 0.0f );
				glTranslated(-31572.0, -9722.0, -8302.0);
				glCallList(495);
			glPopMatrix();

			glPushMatrix();
				glTranslated(31572.0, 9939.0, 9332.4);
				glRotated( -19.83, 1.0f, 0.0f, 0.0f );
				glTranslated(-31572.0, -9942.0, -9332.4);
				glCallList(496);
			glPopMatrix();
		glPopMatrix();
		step += -64.0;
	...
	glPushMatrix();
		glTranslated(31572.0, 9462.0, 7213.0);
		glRotated( -20.21, 1.0f, 0.0f, 0.0f );
		glTranslated(-31572.0, -9462.0, -7213.0);
		glCallList(503);
	glPopMatrix();
...
void DrawStepBricks ()
{
	tp.CreateDisplayList (YZ,  478, 128.0, 128.0, 31582.0, 9914.0, 9872.0, 1.7188, 1.75);
	tp.CreateDisplayList (YZ,  488, 32.0, 128.0, 31582.0, 10134.0, 9868.0, 1.0, 1.78);

	tp.CreateDisplayList (YZ,  479, 128.0, 128.0, 31582.0, 9530.0, 9006.0, 3.21875, 6.0);	
	tp.CreateDisplayList (YZ,  489, 32.0, 128.0, 31582.0, 9942.0, 9004.0, 1.0, 2.55);
	
	tp.CreateDisplayList (YZ,  480, 128.0, 128.0, 31582.0, 9350.0, 7918.0, 2.90625, 6.0);
	tp.CreateDisplayList (YZ,  490, 32.0, 128.0, 31582.0, 9722.0, 7916.0, 1.0, 3.0);
	
	tp.CreateDisplayList (YZ,  481, 128.0, 128.0, 31582.0, 9158.0, 6830.0, 2.375, 6.0);
	tp.CreateDisplayList (YZ,  491, 32.0, 128.0, 31582.0, 9462.0, 6830.0, 1.0, 2.99);

	tp.CreateDisplayList (YZ,  482, 128.0, 128.0, 31582.0, 8966.0, 4590.0, 2.0, 15.0);
	tp.CreateDisplayList (YZ,  492, 32.0, 128.0, 31582.0, 9222.0, 4590.0, 1.0, 12.0);
	...
	tp.CreateDisplayList (YZ, 493, 32.0, 128.0, 31582.0, 9222.0, 6126.0, 1.0, 5.92);
	...
	tp.CreateDisplayList (YZ, 494, 32.0, 128.0, 31582.0, 9462.0, 7213.0, 1.0, 5.93);
	...
	tp.CreateDisplayList (YZ, 495, 32.0, 128.0, 31582.0, 9722.0, 8302.0, 1.0, 5.82);
	...
	tp.CreateDisplayList (YZ, 496, 32.0, 128.0, 31582.0, 9942.0, 9332.4, 1.0, 4.545);

	tp.CreateDisplayList (XZ,  497, 64.0, 128.0, 31518.0, 10166.0, 9868.0, 1.0, 1.78);
	tp.CreateDisplayList (XZ,  498, 64.0, 128.0, 31518.0, 9974.0, 9004.0, 1.0, 2.55);
	tp.CreateDisplayList (XZ,  499, 64.0, 128.0, 31518.0, 9754.0, 7916.0, 1.0, 3.0);
	tp.CreateDisplayList (XZ,  500, 64.0, 128.0, 31518.0, 9494.0, 6830.0, 1.0, 2.99);
	tp.CreateDisplayList (XZ,  501, 64.0, 128.0, 31518.0, 9254.0, 4590.0, 1.0, 12.0);
	tp.CreateDisplayList (XZ, 502, 64.0, 128.0, 31518.0, 9254.0, 6126.0, 1.0, 5.92);
	tp.CreateDisplayList (XZ, 503, 64.0, 128.0, 31518.0, 9494.0, 7213.0, 1.0, 5.95);
	tp.CreateDisplayList (XZ, 504, 64.0, 128.0, 31518.0, 9754.0, 8302.0, 1.0, 5.82);
	tp.CreateDisplayList (XZ, 505, 64.0, 128.0, 31518.0, 9974.0, 9332.4, 1.0, 4.545);
	tp.CreateDisplayList (XY,  506, 64.0, 32.0, 31518.0, 10134.0, 10095.84, 1.0, 1.0);
	tp.CreateDisplayList (XY,  507, 64.0, 64.0, 31518.0, 9914.0, 10095.84, 1.0, 3.4376);
}
